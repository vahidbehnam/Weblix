...
You can install "Weblix - Online Users" directly from the WordPress admin panel:

	1. Visit the Plugins > Add New and search for 'Weblix'.
	2. Click to install.
...
* Updated dashboard widget refresh interval from 5 seconds to 30 seconds for better performance on high-traffic sites.
...
= 1.1 =
This update introduces a weekly cleanup schedule and optimizations for better performance. Update recommended to ensure improved functionality.
